...
MessageTips::MessageTips(QString showStr,QWidget *parent,int x,int y) : QWidget(parent),
   hBoxlayout(new QHBoxLayout(this)),
   mText(new QLabel(this)),
   opacityValue(1.0),
   textSize(18),
   textColor(QColor(255,0,0)),
   backgroundColor(QColor(192,173,100)),
...
void MessageTips::set_text(QString s)
{
    showStr=s;
}
